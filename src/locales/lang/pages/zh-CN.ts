export default {
  ...
  'account.settings.basic-setting': '基本信息',
  ...
  'account.settings.form-submit': '保存',
  'account.settings.security.account-password': '账号密码',
  'account.settings.security.account-password-desc': '当前密码强度: 弱',
